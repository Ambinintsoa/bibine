...
VALUES
    ...
    ('C4', '2021-11-15', 5, 4, 'TPE2', 'MKE21'),
    ('C5 Aircross', '2023-03-20', 5, 4, 'TPE3', 'MKE21'),
    ('Mustang', '2022-02-10', 4, 2, 'TPE1', 'MKE2'),
    ('Camry', '2022-05-25', 5, 4, 'TPE2', 'MKE1'),
    ('Grand Cherokee', '2021-12-12', 5, 4, 'TPE3', 'MKE10'),
    ('Silverado', '2023-01-08', 5, 4, 'TPE4', 'MKE4'),
    (' MX-5', '2022-04-18', 2, 2, 'TPE5', 'MKE19'),
    (' Model S', '2022-03-05', 5, 4, 'TPE6', 'MKE9'),
    (' Evoque', '2023-06-15', 5, 4, 'TPE3', 'MKE22'),
    (' Accord', '2022-07-20', 5, 4, 'TPE2', 'MKE3'),
    (' 3 Series', '2021-09-30', 5, 4, 'TPE1', 'MKE6'),
    (' Q5', '2023-04-12', 5, 4, 'TPE3', 'MKE7'),
    (' Frontier', '2022-08-08', 5, 4, 'TPE4', 'MKE8'),
    (' 911', '2022-11-28', 2, 2, 'TPE1', 'MKE13'),
    ('Explorer', '2021-10-15', 7, 4, 'TPE3', 'MKE2'),
    ('Golf', '2023-02-22', 5, 4, 'TPE2', 'MKE11'),
    (' Kona Electric', '2022-12-05', 5, 4, 'TPE6', 'MKE12'),
    ('Wrangler', '2022-06-10', 4, 2, 'TPE3', 'MKE10'),
    ('Mercedes-Benz C-Class', '2022-09-18', 5, 4, 'TPE2', 'MKE5'),
    ('1500', '2023-03-01', 5, 4, 'TPE4', 'MKE18');
